...
export const MapPanel: React.FC<MapPanelProps> = ({
  goals, activeGoalId, rovPos, rovPath, onMapClick, disabled,
}) => {
  ...
  const pathPoints = rovPath.map(p => {
  ...
  return (
    ...
    >
      ...
      {goals.map((g, idx) => {
        ...
        return (
          <div key={g.id} className="absolute z-20 pointer-events-none"
            style={{ left: ui.x, top: ui.y, transform: 'translate(-50%, -100%)' }}>
